module github.com/mangkoyla/LatinaApi

go 1.20

require (
	github.com/mangkoyla/LatinaBot v0.0.0-20230326033325-b6448c1bdf2f
	github.com/mangkoyla/LatinaSub-go v0.0.0-20230321115334-9f12743854a5
...
replace (
	github.com/mangkoyla/LatinaBot => ../LatinaBot
	github.com/mangkoyla/LatinaSub-go => ../LatinaSub-go
)
...
require (
	...
	gvisor.dev/gvisor v0.0.0-20230228224001-9b4a7aa00f2a // indirect
